define(['MainCore'], function(ImagesInc_Core) {
    ...
    var callback = function(sandBox) {
        return {
            ...
            unregisterFromEvents: function () {
                sandBox.removeEventHandlerFromElem("latestNews", "click", this.handleLatestNewsClick);
                sandBox.removeEventHandlerFromElem("services", "click", this.handleServiceClick);
                sandBox.removeEventHandlerFromElem("support", "click", this.handleSupportClick);
            },
    ...
    ImagesInc_Core.registerComponent("footerContainer", "footer", callback)
});